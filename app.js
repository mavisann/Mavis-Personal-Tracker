...
(function () {
  ...
  var App = {
    ...
    syncGoogleCalendarNow: function () {
      apiFetch("/api/user/google-sync-now", { method: "POST", body: JSON.stringify({}) })
        .then(function () {
          showToast("A full calendar sync has started. Your items will appear shortly.", "success");
        })
        .catch(function (error) {
          showToast(error.message || "Could not start a calendar sync.", "error");
        });
    },
